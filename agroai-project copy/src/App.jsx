...
function HomePage({ t, setPage }) {
  ...
  const FEAT_DETAILS = {
    ...
    crop:     { title:"Smart AI Crop Disease Prediction", icon:"🌾", color:"#4ade80", body:"Drag & drop a crop image for instant AI disease prediction. Our Vision AI detects 300+ diseases, evaluates crop health on a 0–100 scale, identifies disease risk levels, and recommends treatment — all in under 10 seconds.", action:()=>setPage("features") },
  ...
  const feats = [
    ...
    { key:"crop",      icon:"🌾", title:"Smart AI Crop Disease Prediction", desc:"Drag & drop crop images — instant AI disease detection & health analysis.", color:"#4ade80" },
...
function AboutPage() {
  ...
  const team = [
    { name:"Tanishq Kabir",   role:"Frontend Developer",  bg:"👨‍💻", tag:"React · UI/UX · TypeScript", color:"#22d3ee", bio:"Tanishq leads all frontend engineering — building the interactive dashboards, AI crop disease prediction UI, and multi-language interface that make AgroAI's power accessible to every farmer.", skills:["React","TypeScript","Tailwind CSS","D3.js","Figma"] },
  ...
  const milestones = [
    ...
    { year:"2026", event:"AgroAI 2.0 — Smart AI Crop Disease Prediction & Voice AI" },
  ];
...
function FeaturesPage({ setPage }) {
  ...
  return (
    <div className="pe" style={{padding:"4rem 2rem",maxWidth:1100,margin:"0 auto"}}>
      ...
      {/* Flagship crop disease prediction tool */}
      <CropPredictionTool/>
      ...
      <div style={{display:"flex",alignItems:"center",gap:"1rem",marginBottom:"1.75rem",flexWrap:"wrap"}}>
        ...
        <div>
          <div style={{display:"flex",alignItems:"center",gap:8,flexWrap:"wrap"}}>
            <h3 style={{fontSize:"1.18rem",fontWeight:800,fontFamily:"'Syne',sans-serif",color:"#fff"}}>Smart AI Crop Disease Prediction</h3>
            <span style={{background:"rgba(74,222,128,.18)",border:"1px solid rgba(74,222,128,.4)",color:"#4ade80",fontSize:".67rem",fontWeight:700,padding:".18rem .62rem",borderRadius:100,letterSpacing:".06em"}}>FLAGSHIP — DISEASE AI</span>
          </div>
          <p style={{fontSize:".82rem",color:"rgba(255,255,255,.5)",fontFamily:"'Outfit',sans-serif",marginTop:3}}>Drag & drop a crop image — get instant AI disease detection, health score & treatment advice</p>
        </div>
      </div>
...
function ContactPage() {
  ...
  const TAGS = ["Crop Monitoring","Irrigation AI","Weather Forecasting","AI Crop Disease Prediction","Soil Analysis","Voice AI"];
